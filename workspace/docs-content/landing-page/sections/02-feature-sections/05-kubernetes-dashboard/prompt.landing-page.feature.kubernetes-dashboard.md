...
IMPORTANT: Once you process this wait up. I am going to give you the markdown content of github.com landing page that you can use
to size the content for each of the sections that you are going to provide. And I will also explain the specific goal you need to help me with.
...
Now you will give me a two sections that explain the "Kubernetes Dashboard" feature in a way that seems like a continuation and
...
TAKE YOUR TIME. THINK AS HARD AS YOU CAN AND GIVE ME THE BEST POSSIBLE SALES MESSAGE. DONT TAKE IT EASY.
