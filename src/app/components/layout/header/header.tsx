...
import {
  ...
  ProductMenu,
  ProductMenuItem,
} from '@/app/components/layout/header/ProductMenu';
import { Close, DensityMedium } from '@mui/icons-material';
import { Btn, JoinDiscordBtn } from '@/app/components/common';
import {
  StyledDrawer,
  StyledSvgIcon,
  SvgIconSizeResponsive,
} from '@/app/components/layout/header/styled';
import { MenuAccordian } from '@/app/components/layout/header/menu-accordion';
import { JoinBetaBtn } from '@/app/components/landing-page';
