...
import { StyledTabs, StyledTab } from '@/app/components/tabs';
import { StyledInput, StyledSlider } from '@/app/components/pricing-calculator/styled';
import { TypoH3, TypoP1 } from '@/app/components/common';
