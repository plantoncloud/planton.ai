...
> **Screenshot Placeholder**: Connections page showing provider cards with Connect buttons
...
> **Screenshot Placeholder**: AWS connection form with environment authorization checkboxes

4. Click **"Submit"**

**Success!** Your AWS account appears in "Existing Connections" and is ready to use.

> **Screenshot Placeholder**: Existing connections list showing the newly connected AWS account
...
> **Screenshot Placeholder**: Deployment Component Store with Lego Blocks tab selected
...
> **Screenshot Placeholder**: Search results showing AWS VPC component
...
> **Screenshot Placeholder**: VPC deployment form with configuration options
...
> **Screenshot Placeholder**: Stack Job progress showing VPC creation steps
...
> **Screenshot Placeholder**: Cloud Resources list showing the deployed VPC
